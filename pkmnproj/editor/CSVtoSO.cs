...
public class CSVtoSO
{
    ...
    public static void GenerateData()
    {
        ...
        foreach(string s in allLines)
        {
            ...
            pData.type[0] = splitData[10];
            pData.type[1] = splitData[11];
            pData.ability[0] = splitData[12];
            pData.ability[1] = splitData[13];
